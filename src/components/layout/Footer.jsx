                ...
                <div className="grid grid-cols-footer">
                    ...
                    <div className="mb-11 md:mb-0">
                       <h6 className="text-bodyLight font-sfProRegular text-xs pb-4 uppercase"><FormattedMessage id='footer.product' /></h6>
                        ...
                        <a className="font-sfProRegular text-body text-sm block hover:underline" href={REMIX_IDE_URL} target="_blank" rel="noreferrer"><FormattedMessage id='footer.desktopIDE' /></a>
                        <a className="font-sfProRegular text-body text-sm block hover:underline" href="https://github.com/remix-project-org/remix-desktop-insiders" target="_blank" rel="noreferrer">Remix Desktop IDE</a>
